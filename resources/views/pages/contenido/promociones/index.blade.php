<section data-content-panel="promociones" class="content-panel hidden space-y-6">
    <x-ui.page-hero
        title="Promociones"
        description="Administra las promociones y descuentos activos para tus pacientes."
    >
        <x-slot:actions>
            <button type="button" data-promotions-create-open class="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#E91E63] px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#d61b5b]">
                + Nueva promocion
            </button>
        </x-slot:actions>
    </x-ui.page-hero>
