...
>
    <div class="w-full max-w-lg rounded-xl border border-slate-200 bg-white shadow-xl">
        ...
        <form data-edit-user-form class="space-y-4 px-5 py-4">
            ...
            <p data-edit-user-error class="hidden rounded-md border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-700"></p>
